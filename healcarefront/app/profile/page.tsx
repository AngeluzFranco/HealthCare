...
export default function ProfilePage() {
  const { usuario, crearUsuario, actualizarUsuario, loading } = useHealthcare()
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{isEditing ? "Editar Perfil" : "Crear Perfil"}</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {isEditing
                ? "Actualiza tu información personal y objetivos de salud"
                : "Completa tu información personal para comenzar a usar HealthCare"}
            </CardDescription>
          </CardHeader>
          <CardContent>
