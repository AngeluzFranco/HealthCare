...
import { Activity, ArrowLeft, Save, Calendar } from "lucide-react"
import Link from "next/link"
import { format } from "date-fns"
import { es } from "date-fns/locale"

export default function RecordHabitsPage() {
  const { usuario, habitos, registros, crearRegistro, loading } = useHealthcare()
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Primero necesitas crear algunos hábitos para poder registrar tu progreso</p>
          <Link href="/habits">
